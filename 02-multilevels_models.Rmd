...
predictions <- predict_response(
    ...
    print(predictions %>% 
            ...
            labs( y = "Sratas", 
                  ...
                  linetype = "Ethnicity",
                  size = "Age",
                  title = paste("Predicted values for",list_label[k]))+
...
print(
  as.data.frame(
    c("ICC/VPC", "% Sex category", "% Age/generation", "% Ethnicity", "%Intersection"),
    c(ICC_intersect,prop_gender, prop_age, prop_ethnicity,prop_intersection )
  )
)
